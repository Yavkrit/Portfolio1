  ...
  return (
    <div
      ...
      className={`w-72 sm:w-80 rounded-[2rem] p-2 relative flex flex-col items-center hover:scale-[1.02] transition-all duration-700 z-10 ${className} ${
        isActive
          ? 'bg-[#4f46e5] border-indigo-400 shadow-[0_20px_50px_rgba(79,70,229,0.4)]'
          : 'bg-[#161616] light:bg-white border border-white/10 light:border-gray-200 shadow-[0_15px_40px_rgba(0,0,0,0.25)] light:shadow-[0_15px_40px_rgba(0,0,0,0.06)] hover:shadow-[0_20px_50px_rgba(0,0,0,0.35)] light:hover:shadow-[0_20px_50px_rgba(0,0,0,0.12)]'
      }`}
    >
      {/* The hole punch */}
...
const Services = () => {
  ...
  const lineGuideColor = theme === 'light' ? '#cbd5e1' : '#333333';
  const lineDrawColor = theme === 'light' ? '#111111' : '#ffffff';

  return (
    <section
      id="process"
      ref={containerRef}
      className="bg-[#0a0a0a] light:bg-white pt-24 pb-32 px-6 md:px-12 w-full relative overflow-hidden font-sans bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:80px_80px]"
    >
      <div className="max-w-6xl mx-auto relative md:h-[1350px]">
        ...
        <div data-aos="fade-up" className="md:absolute top-10 left-0 md:w-[450px] z-20 mb-16 md:mb-0">
          <div className="inline-block border border-white/20 light:border-gray-300 rounded-full px-5 py-1.5 text-sm text-white/60 light:text-gray-600 font-bold mb-8 shadow-sm bg-white/5 light:bg-white">
            {skillsContent.badge}
          </div>
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white light:text-gray-900 leading-[1.1] mb-6 tracking-tight relative">
            {skillsContent.heading}
            {/* Hand-drawn arrow */}
            <svg className="absolute -bottom-10 right-10 w-12 h-12 text-white/60 light:text-gray-800" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <p className="text-white/50 light:text-gray-500 text-base md:text-lg max-w-sm font-medium leading-relaxed">
        ...
        <div className="flex flex-col gap-8 md:gap-12 items-center md:block relative z-10 w-full pt-4 md:pt-0 pb-12 md:pb-0">
          ...
          <div
            data-aos="fade-in"
            data-aos-delay="600"
            className="hidden md:block absolute top-[1250px] left-[60%] font-['Caveat',cursive] text-3xl text-white/60 light:text-gray-600 rotate-6"
          >
